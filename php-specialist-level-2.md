...
Так как все передаваемые запросы на сервер это строка, нам необходимо произвести сериализацию массива (перевод в зашифрованную строку) и упаковать для сохранения целосности.
